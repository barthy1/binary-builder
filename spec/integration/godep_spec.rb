...
describe 'building a binary', :integration do
  context 'when godep is specified' do
    before(:all) do
      ...
      @binary_tarball_location = File.join(Dir.pwd, "godep-v14-linux-#{platform_short}.tgz")
    end
    ...
    it 'builds the specified binary, tars it, and places it in your current working directory' do
      ...
      godep_version_cmd = "./spec/assets/binary-exerciser.sh godep-v14-linux-#{platform_short}.tgz ./bin/godep version"
